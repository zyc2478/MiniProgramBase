App({
  ...
  globalData: {
    ...
    foods: [
      ...
      { id: 'f103', categoryId: 'cat2', name: '板烧鸡腿堡', price: 32, memberPrice: 28, originalPrice: 38, image: 'https://images.unsplash.com/photo-1513185158878-8d8c196b3c6c?w=400', desc: '整块无骨鸡腿排，肉质鲜嫩，原汁原味。' },
      ...
      // 小食类 - 价格差异化，加入会员价
      { id: 'f301', categoryId: 'cat4', isPopular: true, name: '劲爆鸡米花', price: 18, memberPrice: 15, originalPrice: 22, image: 'https://images.unsplash.com/photo-1569058242253-92a9c71f9867?w=400', desc: '外焦里嫩，颗颗劲爆。' },
